...
import { MpesaTransactionsService } from 'src/app/@core/services/mpesa/mpesa-transactions.service';
...
export class BasicListComponent implements OnInit {
  ...
  constructor(
    private mpesaTransactionsService: MpesaTransactionsService,
  ...
  getList() {
    this.busy = this.mpesaTransactionsService.sendGetRequest().subscribe((data: any[])=>{
      console.log(data);
      this.basicDataSource = data;
    }) 
  }
